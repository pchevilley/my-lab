    ...
    return <section className="about-me">
        <div className="hero">
            <div className="hero__text">
                ...
                <h2>I am a professional Web developer with more than 10 years of experience</h2>
            </div>
            ...
            <Image  src="/profile.jpg" alt="A photo of Paul" width={300} height={300} className="hero__image" />
        </div>
    </section>
}
